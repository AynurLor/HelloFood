    ...
    override fun onMapReady(googleMap: GoogleMap) {
        ...
        database.child(Firebase.auth.currentUser!!.uid).get().addOnSuccessListener {
            if (it.exists()) {
                ...
                googleMap.addMarker(MarkerOptions().position(user).title(getString(R.string.title_user)))?.showInfoWindow()
            }
        }
        ...
        database.child(shopId).get().addOnSuccessListener {
            if (it.exists()) {
                ...
                googleMap.addMarker(MarkerOptions().position(shop).title(getString(R.string.title_restaurant)))?.showInfoWindow()
