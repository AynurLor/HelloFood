    ...
    private fun updatePaymentStatus() {
        ...
        database.updateChildren(order).addOnSuccessListener {
            ...
            database.updateChildren(or).addOnSuccessListener {
                ...
                (activity as HomeActivity).replaceFragment(CurrentOrdersFragment(), getString(R.string.title_current_order))
...
//                    TODO: испарвить Delivery
                    if(binding.tvOrderType.text != getString(R.string.radio_button_delivery)){
