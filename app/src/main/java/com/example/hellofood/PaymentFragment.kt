        ...
        binding.btnCashPay.setOnClickListener {
            ...
            database.setValue(payment)
                ...
                .addOnFailureListener {
                    Toast.makeText(context, R.string.toast_text_payment_failed, Toast.LENGTH_LONG).show()
                }
        }
                ...
                if (snapshot.exists()) {
                    ...
                    if(orderId == "Pick Up"){
                        ...
                        database.child(pushKey!!).setValue(item)
                            ...
                            .addOnFailureListener {
                                Toast.makeText(context, R.string.toast_text_failed, Toast.LENGTH_LONG).show()
                            }
                    }else{
                        price += 50
