            ...
            ref.addListenerForSingleValueEvent(object : ValueEventListener {
                override fun onDataChange(snapshot: DataSnapshot) {
                    if (snapshot.exists()) {
                        ...
                        alertDialog.setMessage(R.string.notify_have_active_order)
...
private fun deleteWholeCart() {
    ...
    Toast.makeText(this, R.string.toast_text_removed_all_items, Toast.LENGTH_SHORT).show()
...
private fun updateCartData(itemId: String, qty: Int) {
    ...
    database.child(Firebase.auth.currentUser!!.uid).child(itemId)
        ...
        .addOnSuccessListener {
            Toast.makeText(this, R.string.toast_text_ok, Toast.LENGTH_SHORT).show()
        }
}
